...
import { UtensilsCrossed, Activity, Brain, AlertCircle, Pill, Dumbbell, Droplets } from 'lucide-react';
...
export default function ActionBar({ onAction }: ActionBarProps) {
  const actions = [
    ...
    { type: 'BATHROOM' as EntryType, icon: Droplets, label: 'Toa' },
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-lg border-t border-gray-800 p-3 pb-safe z-40">
      <div className="grid grid-cols-6 gap-1.5 max-w-2xl mx-auto px-4">
